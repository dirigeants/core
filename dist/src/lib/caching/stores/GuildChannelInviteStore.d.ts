...
import type { InviteTargetUserType } from '@klasa/dapi-types';
 ...
 * @since 0.0.3
 */
export declare class GuildChannelInviteStore extends ProxyCache<string, Invite> {
    /**
     ...
     */
    constructor(channel: GuildChannel, keys: string[]);
    /**
     ...
     */
    add(data: GuildChannelInviteStoreAddData, requestOptions?: RequestOptions): Promise<Invite>;
    /**
     ...
     */
    remove(code: string, requestOptions?: RequestOptions): Promise<this>;
    /**
